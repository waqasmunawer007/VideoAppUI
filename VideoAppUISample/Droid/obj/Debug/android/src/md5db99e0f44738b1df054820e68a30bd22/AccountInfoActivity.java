...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("VideoAppUISample.Droid.AccountInfoActivity, VideoAppUISample.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", AccountInfoActivity.class, __md_methods);
	}


	public AccountInfoActivity () throws java.lang.Throwable
	{
		super ();
		if (getClass () == AccountInfoActivity.class)
			mono.android.TypeManager.Activate ("VideoAppUISample.Droid.AccountInfoActivity, VideoAppUISample.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
