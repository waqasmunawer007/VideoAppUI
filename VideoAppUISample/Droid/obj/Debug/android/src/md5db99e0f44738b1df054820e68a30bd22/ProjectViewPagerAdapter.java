...
public class ProjectViewPagerAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("VideoAppUISample.Droid.ProjectViewPagerAdapter, VideoAppUISample.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", ProjectViewPagerAdapter.class, __md_methods);
	}


	public ProjectViewPagerAdapter () throws java.lang.Throwable
	{
		super ();
		if (getClass () == ProjectViewPagerAdapter.class)
			mono.android.TypeManager.Activate ("VideoAppUISample.Droid.ProjectViewPagerAdapter, VideoAppUISample.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
