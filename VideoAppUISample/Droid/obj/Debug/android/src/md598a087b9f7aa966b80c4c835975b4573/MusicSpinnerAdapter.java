...
public class MusicSpinnerAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("VideoAppUISample.Droid.Adapters.MusicSpinnerAdapter, VideoAppUISample.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", MusicSpinnerAdapter.class, __md_methods);
	}


	public MusicSpinnerAdapter () throws java.lang.Throwable
	{
		super ();
		if (getClass () == MusicSpinnerAdapter.class)
			mono.android.TypeManager.Activate ("VideoAppUISample.Droid.Adapters.MusicSpinnerAdapter, VideoAppUISample.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
