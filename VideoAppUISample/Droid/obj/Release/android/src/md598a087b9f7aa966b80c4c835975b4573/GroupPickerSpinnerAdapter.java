...
public class GroupPickerSpinnerAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("VideoAppUISample.Droid.Adapters.GroupPickerSpinnerAdapter, VideoAppUISample.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", GroupPickerSpinnerAdapter.class, __md_methods);
	}


	public GroupPickerSpinnerAdapter () throws java.lang.Throwable
	{
		super ();
		if (getClass () == GroupPickerSpinnerAdapter.class)
			mono.android.TypeManager.Activate ("VideoAppUISample.Droid.Adapters.GroupPickerSpinnerAdapter, VideoAppUISample.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
